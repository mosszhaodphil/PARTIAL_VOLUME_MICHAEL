...
function pv_script(str_file, t1_file, perfusion_file, mask_file, kernel_size)
	...
	display(sprintf('Performing segmentation...'));
	...
	display(sprintf('Performing Partial Volume Correction...'));

	pv_correct(perfusion_file, file_name_gm, file_name_wm, mask_file, kernel_size);

	display(sprintf('Result saved to perfusion_gm.nii.gz and perfusion_wm.nii.gz\n\n'));
