function pv_correct(dir,datastr,gmstr,wmstr,maskstr,ksize,outstr)
    ...
    cbf_file_handle  = load_nii([dir datastr]);
    gm_file_handle   = load_nii([dir gmstr]);
    wm_file_handle   = load_nii([dir wmstr]);
    mask_file_handle = load_nii([dir maskstr]);
    ...
    save_nii(gm_file_handle, 'gm_result.nii.gz');
    save_nii(wm_file_handle, 'wm_result.nii.gz');
